...
def analysis_sub(plotvariables,figure_counter_sub,Sample,Harmonic,min_field,max_field,Y,despike,mother,wavelet_lvls,smooth,smoothtype,window,windowtype,write,write_fft):
